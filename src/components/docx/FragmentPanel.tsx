...
const FragmentPanel = () => {
    ...
    const { estCost, charCount } = useMemo(() => {
        ...
        const estCost = docxData ? String(((docxData.totalLength / 1000000) * 20).toFixed(2)) : '0'; // 20 USD per 1M chars
        const charCount = docxData ? docxData.totalLength.toLocaleString().replace(/,/g, ' ') : '0';
        ...
        <>
            ...
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <Transition show={!!downloadLink && !!fragData} {...transitionProperties}>
                        <div className="flex gap-4">
                            {fragData && (
                                <>
                                    <FileInfo
