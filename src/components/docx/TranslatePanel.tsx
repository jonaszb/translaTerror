...
const TranslatePanel = () => {
    ...
    const conditions = useMemo(
        () => [
            ...
            {
                isMet: !!(docxData?.sourceLength && docxData.sourceLength < 500000),
                title: '< 500 000 chars',
                mandatory: false,
            },
        ],
    ...
    const { estCost, charCount } = useMemo(() => {
        if (!docxData || !allConditionsMet) return { estCost: 'N/A', charCount: 'N/A' };
        ...
        <>
            ...
            <div className="flex items-end justify-between">
                <div className="flex gap-8">
                    ...
                    <FileInfo label="Estimated cost" value={estCost} currency={allConditionsMet ? '$' : undefined} />
                </div>
                <ActionButton
