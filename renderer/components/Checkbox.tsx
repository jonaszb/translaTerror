...
export const Checkbox: FC<{ id: string; checked: boolean; onChange: () => void }> = (props) => {
    return (
        <>
            ...
            <label
                htmlFor={props.id}
                className={`flex aspect-square h-6 w-6 cursor-pointer items-center justify-center rounded-full border border-zinc-600 bg-zinc-900 hover:border-amber-200 peer-checked:border-amber-200`}
            >
                <Transition
                    show={!!props.checked}
